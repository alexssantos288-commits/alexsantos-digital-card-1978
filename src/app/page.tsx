          ...
          <div className="relative flex overflow-x-hidden border-y border-white/5 py-6 sm:py-10 bg-black/20 backdrop-blur-sm">
            <div className="flex animate-marquee whitespace-nowrap gap-10 sm:gap-20 items-center">
              {[1, 2, 3, 4, 5, 6, 1, 2, 3, 4, 5, 6].map((i, idx) => (
                <div key={idx} className="flex items-center gap-2 sm:gap-3 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all duration-500 cursor-pointer">
                  ...
                  <span className="font-black text-base sm:text-xl tracking-tighter uppercase">Parceiro {i}</span>
                </div>
              ))}
            </div>
          </div>
